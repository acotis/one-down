...
- Preface a clue with `@Draft` to mark it as a draft; it will show up in orange in the image render.
- Preface a clue with `@Tentative` to mark it as tentative; it will show up in pale grey in the image render.
